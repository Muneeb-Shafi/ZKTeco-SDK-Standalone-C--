...
// throw new NotImplementedException();
        ...
        public int sta_GetAllUserFPInfo(ListBox lblOutputInfo, ProgressBar prgSta, ListView lvUserInfo)
        {
            ...
            string insertQuery = @"
        INSERT INTO Users (Enable, Name, CardNo, Password, FingerIndex, Flag, FingerPrint, Privilege)
...
*/
        ...
        */
        ...
        ////Sample Function to List Functions 
        ///
        public void getDevices(DataTable dt_devlog)
        {
            ...
            {
                Console.WriteLine("SearchDevice failed, error code: {0}");
            }
        }
        ...
        private List<string> sta_batchDownloadBioTemplates(System.Windows.Forms.ProgressBar procBar, int aBioType)
        {
            ...
            foreach (Employee e in employeeList)
            {
                ...
                datacount = axCZKEM1.SSR_GetDeviceDataCount(PersBioTableName, filter, emptys);

...
namespace StandaloneSDKDemo
{
    public partial class TerminalForm : Form
    {
        ...
        * *******************************************************************************************************************************************/
        ...
        {
            Cursor = Cursors.WaitCursor;
            DataTable dt_devlog = new DataTable("dt_devlog");
            gv_devlog.AutoGenerateColumns = true;
            gv_devlog.Columns.Clear();
            dt_devlog.Columns.Add("Sr No", System.Type.GetType("System.String"));
            dt_devlog.Columns.Add("IP Address", System.Type.GetType("System.String"));
            dt_devlog.Columns.Add("Mac Address", System.Type.GetType("System.String"));
            dt_devlog.Columns.Add("Status", System.Type.GetType("System.Int32"));
            gv_devlog.DataSource = dt_devlog;
            Terminal.SDK.getDevices(dt_devlog);
            Cursor = Cursors.Default;

        }

        private void gv_devlog_SelectionChanged(object sender, EventArgs e)
        {
            if (gv_devlog.SelectedRows.Count > 0)
            {
                DataGridViewRow selectedRow = gv_devlog.SelectedRows[0];
                string ipAddress = selectedRow.Cells["IP Address"].Value.ToString();

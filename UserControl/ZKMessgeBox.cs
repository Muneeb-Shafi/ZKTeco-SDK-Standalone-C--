...
namespace StandaloneSDKDemo
{
    public partial class ZKMessgeBox :Form
    {
        ...
        static void newMessageBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            LinearGradientBrush frmLGBL = new LinearGradientBrush(frmTitleL, Color.FromArgb(34, 100, 255), Color.FromArgb(34, 100, 255), LinearGradientMode.Horizontal);
            LinearGradientBrush frmLGBR = new LinearGradientBrush(frmTitleR, Color.FromArgb(34, 100, 255), Color.FromArgb(34, 100, 255), LinearGradientMode.Horizontal);
            Pen frmPen = new Pen(Color.FromArgb(34, 100, 255), 1);
            g.FillRectangle(frmLGBL, frmTitleL);
            g.FillRectangle(frmLGBR, frmTitleR);
            g.DrawRectangle(frmPen, frmMessageBox);
        }

        private void ZKMessgeBox_Load(object sender, EventArgs e)
        {
